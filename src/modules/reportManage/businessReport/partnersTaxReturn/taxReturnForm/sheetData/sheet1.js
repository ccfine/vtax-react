...
export default [
    ...
    [
        {readOnly: true,value: '一、一般计税方法计税',rowSpan:8},
    ...
    generateData('F',14,5,{readOnly: true,value: '6%税率	',colSpan:2}),

    [
        {readOnly: true,value: '其中：即征即退项目',rowSpan:2},
        ...generateData('G',14,6,{readOnly: true,value: '即征即退货物及加工修理修配劳务',colSpan:2}),
    ],

    generateData('H',14,7,{readOnly: true,value: '即征即退服务、不动产和无形资产	',colSpan:2}),

    [
        {readOnly: true,value: '二、简易计税方法计税',rowSpan:11},
        {readOnly: true,value: '全部征税项目',rowSpan:9},
        ...generateData('I',14,8,{readOnly: true,value: '6%征收率',colSpan:2}),
    ],

    generateData('J',14,'9a',{readOnly: true,value: '5%征收率的货物及加工修理修配劳务',colSpan:2}),
    generateData('K',14,'9b',{readOnly: true,value: '5%征收率的服务、不动产和无形资产',colSpan:2}),
    generateData('L',14,10,{readOnly: true,value: '4%征收率',colSpan:2}),
    generateData('M',14,11,{readOnly: true,value: '3%征收率的货物及加工修理修配劳务',colSpan:2}),
    generateData('N',14,12,{readOnly: true,value: '3%征收率的服务、不动产和无形资产',colSpan:2}),
    generateData('O',14,'13a',{readOnly: true,value: '预征率',colSpan:2}),
    generateData('P',14,'13b',{readOnly: true,value: '预征率',colSpan:2}),
    generateData('Q',14,'13c',{readOnly: true,value: '预征率',colSpan:2}),

    [
        {readOnly: true,value: '其中：即征即退项目',rowSpan:2},
        ...generateData('R',14,14,{readOnly: true,value: '即征即退货物及加工修理修配劳务',colSpan:2}),
    ],

    generateData('S',14,15,{readOnly: true,value: '即征即退服务、不动产和无形资产',colSpan:2}),


    [
        {readOnly: true,value: '三、免抵退税',rowSpan:2},
        ...generateData('T',14,16,{readOnly: true,value: '货物及加工修理修配劳务',colSpan:3}),
    ],

    generateData('U',14,17,{readOnly: true,value: '服务、不动产和无形资产',colSpan:3}),

    [
        {readOnly: true,value: '四、免税',rowSpan:2},
        ...generateData('V',14,18,{readOnly: true,value: '货物及加工修理修配劳务',colSpan:3}),
    ],
